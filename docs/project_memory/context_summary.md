...
Backend tests: 316, all passing (see Known Problems re: 2 flaky Stripe-network tests). The backend
...
- TIME-080 (net-new) → Jira TIME-78 (Local-time-aware Now: greeting + wind-down moment) — **Done (this session)**
