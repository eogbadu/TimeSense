...
Backend tests: 321, all passing (see Known Problems re: 2 flaky Stripe-network tests). The backend
...
- TIME-082 (net-new) → Jira TIME-80 (Task duration brain: seed table + learned estimates) — **Done (this session)**
