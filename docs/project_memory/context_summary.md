...
- TIME-103..108 → Jira TIME-103..108 (Location-aware feature: geofence arrival notifications, Settings deep-link, reliable state, radius tuning, multiple places, **location shapes the recommendation**) — **Done (PRs #97-102 merged 2026-07-07)**
